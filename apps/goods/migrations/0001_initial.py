# Generated by Django 2.0 on 2020-03-09 12:57
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加的时间')),
            ],
            options={
                'verbose_name': '主页的轮播图',
                'verbose_name_plural': '主页的轮播图',
            },
        ),
        migrations.CreateModel(
            name='Goods',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('goods_on', models.CharField(default='', max_length=30, verbose_name='商品的唯一货号')),
                ...
                ('goods_desc', extra_apps.DjangoUeditor.models.UEditorField(default='', verbose_name='商品主要内容')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(blank=True, null=True, upload_to='goods/images', verbose_name='轮播图片')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加的时间')),
        ...
        migrations.AddField(
            model_name='goods',
            name='category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='goods.GoodsCategory', verbose_name='商品的类别'),
        ),
        migrations.AddField(
            model_name='banner',
            name='goods',
